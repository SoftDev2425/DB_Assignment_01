...
const scraper3 = (con) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        ...
        fs_1.default.createReadStream(path)
            ...
            const GHG_emissions = {
                ...
                measurementYear: isNaN(parseInt((0, date_fns_1.format)(new Date(data[6]), "yyyy")))
                    ? null
                    : parseInt((0, date_fns_1.format)(new Date(data[6]), "yyyy")),
          ...
          `;
              ...
              END
              `;
                    const newEmissionStatusType = yield con.query `
          ...
          `;
                    ...
                    const newGHG_Emission = yield con.query `
              BEGIN
